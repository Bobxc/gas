...
<script>
import { apiAddres, gasType, Fullsupply } from '../../common/common.js';
export default {
	data() {
		return {
			token: '',
			...
			gcCarrierCorpNumber: 1234567890,
			gcCarrierName: '测试员03',
			//区域编号
			region_id: '',
			//企业编号
	...
	methods: {
		...
		toGoBack() {
			...
			if(this.gasList.length > 0) {
				...
				this.data.gcCarrierCorpNumber = this.gcCarrierCorpNumber
				this.data.gcCarrierName = this.gcCarrierName
